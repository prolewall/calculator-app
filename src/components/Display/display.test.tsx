...
describe("Display", () => {
    ...
    it("should correctly display calculation without previous input", () => {
        renderComponent({currentInput: "0", previousResult: "12.34", operation: MathematicalOperation.Add});
    ...
    it("should correctly display calculation with previous input", () => {
        renderComponent({currentInput: "0", previousResult: "12.34", operation: MathematicalOperation.Multiply, previousInput: "3"});
